...
# example usage: python convert_json_to_yolo.py -o annotations_detection/ -j annotations.json

parser = argparse.ArgumentParser()
parser.add_argument("-j", "--json", help="Path to input json", required=True)
parser.add_argument("-o", "--output", help="Path to output directory", default="annotations_detection/")

args = parser.parse_args()

def convert_json_to_yolo(json_path, output_dir="labels/train", class_id=0):
