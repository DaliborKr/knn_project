...
LABELS_FOLDER_PATH = '/labels' # Replace with your folder path
OUTPUT_JSON_FILE = 'tracking_results_imprassoc/d2_01.json' # Replace with your output JSON path
...
output_json = load_data(LABELS_FOLDER_PATH)
