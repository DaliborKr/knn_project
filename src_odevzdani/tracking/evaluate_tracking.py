...
# INPUT:
GROUND_TRUTH_DIR = "dataset_ground_truth_tracks"
TRACKER_OUTPUT_DIR = "tracking_results/tracking_results_botsort"

#OUTPUT
RESULTS_OUTPUT_PATH = "tracking_eval_results/eval_botsort.json"
...
def analyze_tracking(match_info, best_tracker_id):
    ...
    for _, current_id in match_info_sorted:
        if current_id == -1:
            ...
            if in_gap and current_id != prev_id and prev_id is not None:
                fragmentations += 1
...
trackers_output_dir = TRACKER_OUTPUT_DIR

#OUTPUT
results_file_path = RESULTS_OUTPUT_PATH
